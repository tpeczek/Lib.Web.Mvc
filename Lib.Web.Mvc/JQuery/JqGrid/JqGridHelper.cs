...
namespace Lib.Web.Mvc.JQuery.JqGrid
{
    ...
    public class JqGridHelper<TModel> : IJqGridHelper
    {
        ...
        /// <param name="iconSet">The icon set for Bootstrap 4 CSS framework.</param>
