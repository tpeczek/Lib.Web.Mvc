...
namespace Lib.Web.Mvc
{
    internal class AntiForgeryDataSerializer
    {
        ...
        {
            return new HttpAntiForgeryException(Resources.AntiForgeryToken_ValidationFailed, innerException);
        }
        ...
        public virtual AntiForgeryData Deserialize(string serializedToken)
        {
            ...
            {
                throw new ArgumentException(Resources.Common_NullOrEmpty, "serializedToken");
            }
